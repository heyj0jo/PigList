...
submitBtn.addEventListener('click', function () {
    ...
    var newWeight = document.getElementById("new-weight").value;
    var newCategory = document.getElementById("new-category").value;
    var newBreed = document.getElementById("new-breed").value;
    var newPersonality = document.getElementById("new-personality").value;
    var newSkillValue = document.getElementById("skillValue").value;
...
window.onload = function () {
    ...
    var wsorted = w.wpigs.sort((a, b) => a.name.localeCompare(b.name));
    var bsorted = b.bpigs.sort((a, b) => a.name.localeCompare(b.name));
    var gsorted = g.gpigs.sort((a, b) => a.name.localeCompare(b.name));
    var csorted = c.cpigs.sort((a, b) => a.name.localeCompare(b.name));
...
var mainTable = document.getElementById("pigInfo");
function addNew(n, c, b, h, w, p, sn, sv) {
    var mainTable = document.getElementById("pigInfo");
...
function showMoreInfo(n, c, b, h, w, p, sn, sv) {
    var tableSec = document.getElementById("hidden-more");
    var moreInfoTb = (document.createElement("table"));
...
addCategorySel.onchange = function () {
    ...
    var skillVal = document.getElementById("skillValue");
